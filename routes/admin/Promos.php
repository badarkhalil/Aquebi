...
// Featured Vendors:
Route::get('promotions/featuredVendors/edit', [PromotionsController::class, 'editFeaturedVendors'])->name('featuredVendors.edit');
Route::put('promotions/featuredVendors/update', [PromotionsController::class, 'updateFeaturedVendors'])->name('update.featuredVendors');
