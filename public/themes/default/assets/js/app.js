...
; (function ($, window, document) {
	...
	function initSlickSliders(rtl = false) {
		...
		//for announcement slick slider frontend
		$('.header__enouncement').css('display', 'block');
		$('.announcement-slick').slick({
			arrows: true,
			autoplay: true,
			autoplaySpeed: 5000,
			nextArrow: '<span class="arrow slick-next slick-arrow"></span>',
			prevArrow: '<span class="arrow slick-prev slick-arrow"></span>',
		});
