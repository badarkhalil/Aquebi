<div class="share">
  <span>
    ...
    <a href="https://pinterest.com/pin/create/button/?{{ http_build_query(['url' => Request::fullUrl(),'media' => get_product_img_src($item, 'medium'),'description' => $item->title]) }}" class="social-share-btn" target="_blank" rel="noopener" data-toggle="tooltip" data-placement="top" title="@lang('theme.share_on',['name' => 'pinterest'])"><i class="fa fa-pinterest"></i></a>
    ...
    <a href="http://vk.com/share.php?{{ http_build_query(['url' => Request::fullUrl(),'title' => $item->title,'image' => get_product_img_src($item, 'medium'),'noparse' => false]) }}" class="social-share-btn" target="_blank" rel="noopener" data-toggle="tooltip" data-placement="top" title="@lang('theme.share_on',['name' => 'vk'])"><i class="fa fa-vk"></i></a>
...
{{--    <a href="http://www.viadeo.com/?{{ http_build_query(['url' => Request::fullUrl(),'title' => $item->title,'image' => get_product_img_src($item, 'medium')]) }}" class="social-share-btn" target="_blank" rel="noopener" data-toggle="tooltip" data-placement="top" title="@lang('theme.share_on',['name' => 'viadeo'])"><i class="fa fa-viadeo"></i></a>--}}
