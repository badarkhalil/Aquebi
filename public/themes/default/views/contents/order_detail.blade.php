        ...
        <table class="table" id="buyer-payment-detail-table">
          ...
          <tbody>
            ...
            <tr class="buyer-payment-info-body">
              ...
              <td>{{ get_formated_currency($order->get_shipping_cost(), true, 2) }}</td>
              ...
              <tr class="order-body">
                <td colspan="2">
                  <div class="product-img-wrap">
                    <img class="lazy" src="/images/loading.webp" data-src="{{ get_storage_file_url(optional($item->image)->path, 'small') }}" alt="{{ $item->slug }}" title="{{ $item->slug }}" />
                  </div>
              ...
              <div class="message-content-wrapper">
                ...
                @if ($attachment = optional($msg->attachments)->first())
                  <a href="{{ get_storage_file_url($attachment->path, 'original') }}" class="pull-right message-attachment" target="_blank" rel="noopener">
                    <img src="/images/loading.webp" data-src="{{ get_storage_file_url($attachment->path, 'tiny') }}" class="lazy img-sm thumbnail">
                  </a>
                @endif
              </div>
            </div>
          ...
          <div class="col-8">
            <div class="message-content-wrapper">
              ...
              @if ($attachment = optional($order->conversation->attachments)->first())
                <a href="{{ get_storage_file_url($attachment->path, 'original') }}" class="pull-right message-attachment" target="_blank" rel="noopener">
                  <img src="/images/loading.webp" src="{{ get_storage_file_url($attachment->path, 'tiny') }}" class="lazy img-sm thumbnail">
                </a>
              @endif
            </div>
          </div>
