            ...
            <tr class="order-body">
              <td>
                <div class="product-img-wrap">
                  <img class="lazy" src="/images/loading.webp" data-src="{{ get_storage_file_url(optional($order->shop->image)->path, 'small') }}" alt="{{ $order->shop->slug }}" title="{{ $order->shop->slug }}" />
                </div>
          ...
          <tbody>
            ...
            @foreach ($order->inventories as $item)
              <tr class="order-body">
                <td>
                  <div class="product-img-wrap">
                    <img class="lazy" src="/images/loading.webp" data-src="{{ get_inventory_img_src($item, 'small') }}" alt="{{ $item->slug }}" title="{{ $item->slug }}" />
                  </div>
                  <div class="product-info">
