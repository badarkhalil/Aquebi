      ...
      <div class="col-md-4 bg-light">
        <div class="seller-info my-3">
          ...
          <a href="{{ route('show.store', $shop->slug) }}" class="seller-info-name mr-3">
            <img src="/images/loading.webp" data-src="{{ get_storage_file_url(optional($shop->logoImage)->path, 'thumbnail') }}" class="seller-info-logo img-sm lazy" title="{{ $shop->name }}" alt="{{ trans('theme.logo') }}">
          </a>
