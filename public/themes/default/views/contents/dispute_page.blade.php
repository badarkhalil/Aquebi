                    ...
                    @foreach ($order->dispute->replies as $reply)
                      <div class="row">
                        <div class="col-md-2 nopadding-right no-print">
                          @if ($reply->user_id)
                            @if ($reply->user->image)
                              <img src="/images/loading.webp" data-src="{{ get_storage_file_url(optional($reply->user->image)->path, 'thumbnail') }}" class="lazy img-circle img-sm" alt="{{ trans('app.avatar') }}">
                            @else
                              <img src="/images/loading.webp" data-src="{{ get_gravatar_url($reply->user->email, 'thumbnail') }}" class="lazy img-circle img-sm" alt="{{ trans('app.avatar') }}">
                            @endif
                        ...
                        <div class="col-md-2 nopadding-left no-print">
                          @if ($reply->customer_id)
                            @if ($reply->customer->image)
                              <img src="/images/loading.webp" data-src="{{ get_storage_file_url(optional($reply->customer->image)->path, 'thumbnail') }}" class="lazy img-circle img-sm" alt="{{ trans('app.avatar') }}">
                            @else
                              <img src="/images/loading.webp" data-src="{{ get_gravatar_url($reply->customer->email, 'thumbnail') }}" class="lazy img-circle img-sm" alt="{{ trans('app.avatar') }}">
                            @endif
