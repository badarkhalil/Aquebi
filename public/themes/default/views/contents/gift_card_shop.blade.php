    ...
    <div class="col-md-3">
      <div class="product product-grid-view sc-product-item">
        ...
        <div class="product-img-wrap">
          <img class="product-img-primary lazy" src="/images/loading.webp" data-src="{{ get_product_img_src($item, 'medium') }}" data-name="product_image" alt="{{ $item->title }}" title="{{ $item->title }}" />
        ...
        <div class="product-actions btn-group">
          ...
          <a class="btn btn-default flat itemQuickView" href="javascript:void(0);" data-link="{{ route('quickView.product', $item->slug) }}" rel="nofollow noindex">
