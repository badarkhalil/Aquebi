          ...
          <td class="mailbox-name" width="15%">
            @if ($message->shop)
              <a href="{{ route('show.store', $message->shop->slug) }}">
                <img src="/images/loading.webp" data-src="{{ get_storage_file_url(optional($message->shop->image)->path, 'thumbnail') }}" class="lazy seller-info-logo img-circle" alt="{{ trans('theme.logo') }}">
